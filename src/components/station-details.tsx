...
import { Car, Phone, MapPin, Clock, Footprints, Bike, Bus, Copy, ChevronUp } from "lucide-react";
...
export function StationDetails({ stations, selectedStationIndex, onStationSelect, routeDetails, travelMode, onTravelModeChange, userAddress, userCoordinates }: StationDetailsProps) {
  ...
  return (
    <Card className="shadow-2xl rounded-xl md:rounded-lg bg-background/90 backdrop-blur-sm md:bg-card md:backdrop-blur-none">
      <Collapsible
      ...
      >
        <CollapsibleTrigger asChild disabled={!isMobile}>
          <div className={cn("w-full", isMobile ? "cursor-pointer" : "cursor-default")}>
            <CardHeader>
        ...
        <CollapsibleContent>
          <div className="flex flex-col">
            ...
            <CardContent className="p-0">
              <ScrollArea className="max-h-[45vh] md:max-h-[calc(100vh-350px)]">
